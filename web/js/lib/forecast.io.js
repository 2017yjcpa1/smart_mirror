...
(function(root, factory) {
	...
	*/
	...
	function ForecastIOConditions(rawData) {
		 ...
		 * @return type
		 */
		this.getPrecipitationType = function() {//강수
		 ...
		 * @return type
		 */
		this.getPrecipitationProbability = function() {//강수
		 ...
		 * @return type
		 */
		this.getCloudCover = function() {//운량
		 ...
		 * @return type
		 */
		this.getMinTemperature = function() {//최저기온
		 ...
		 * @return type
		 */
		this.getMaxTemperature = function() {//최대기온
		 ...
		 * @return type
		 */
		this.getSunrise = function() {//해뜨는시간
		 ...
		 * @return number
		 */
		this.getPrecipIntensity = function() {//저녁노을
